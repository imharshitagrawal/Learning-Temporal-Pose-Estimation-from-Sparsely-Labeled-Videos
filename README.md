...
### Datasets used
The dataset used in this project is [***Posetrack 2018***](https://posetrack.net/users/download.php). The new release contains 1356 annotated sequences (593 train, 170 validation and 375 test) with 276,198 annotated body poses in total.
